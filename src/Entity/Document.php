...
abstract class Document extends Entity
{
    ...
    #[ORM\ManyToOne(targetEntity: Order::class, inversedBy: 'pedidos')]
    public Order $pedido;
    */

    #[ORM\JoinColumn(name: 'albaran', referencedColumnName: 'id')]
    #[ORM\ManyToOne(targetEntity: DeliveryNote::class, inversedBy: 'albaranes')]
    public DeliveryNote $albaran;

    #[ORM\JoinColumn(name: 'factura', referencedColumnName: 'id')]
    #[ORM\ManyToOne(targetEntity: Invoice::class, inversedBy: 'facturas')]
