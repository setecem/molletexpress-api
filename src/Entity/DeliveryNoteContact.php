...
#[ORM\Table(name: 'delivery_note_contact')]
#[ORM\Entity]
class DeliveryNoteContact extends Entity
{
    #[ORM\JoinColumn(name: 'delivery_note_id', referencedColumnName: 'id')]
    #[ORM\ManyToOne(targetEntity: DeliveryNote::class, inversedBy: 'contacts')]
